...
if args.transcript_only:
    ...
    movie.init(output_dir, force_overwrite_mouth_data=force_overwrite_mouth_data, force_overwrite_transcript=force_overwrite_transcript, force_overwrite_audio=force_overwrite_audio, force_delete_frames=force_delete_frames)
